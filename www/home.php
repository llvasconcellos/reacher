...
require("funcoes.php");
inicia_pagina();
monta_titulo_secao("Bemvindo ao Re@acher!");
?>
<table width="100%">
	<tr>
		<td width="25%">
			...
			<? inicia_quadro_branco('width="100%"', "Pagina Inicial"); ?>
				<center>
					<table width="90%">
						...
						<tr height="50">
							<td valign="top" align="center" width="25%"><a class="menu" href="browser_instituicoes.php"><img border="0" src="imagens/icone_instituicao_gr.gif"></a></td>
							<td valign="top" align="center" width="25%"><a class="menu" href="browser_pessoas.php"><img border="0" src="imagens/icone_pessoa_gr.gif"></a></td>
							<td valign="top" align="center" width="25%"><a class="menu" href="browser_segmentos.php"><img border="0" src="imagens/icone_segmento_gr.gif"></a></td>
							<td valign="top" align="center" width="25%"><a class="menu" href="browser_modelos.php"><img border="0" src="imagens/icone_modelo_gr.gif"></a></td>
						</tr>
						<tr height="60">
							<td valign="top" align="center"><a class="menu" href="browser_instituicoes.php">Instituições</a></td>
