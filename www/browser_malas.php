...
require("funcoes.php");
inicia_pagina();
monta_titulo_secao("Malas Diretas Cadastrados");
...
$query = "SELECT ";
$query .= " CONCAT('<a title=\"Editar\" href=\"form_mala.php?modo=update&id_mala=', id_mala , '\"><img border=\"0\" src=\"imagens/editar.gif\"></a>') as id_mala,";
